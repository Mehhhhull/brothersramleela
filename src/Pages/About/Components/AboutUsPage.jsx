...
const AboutUsPage = () => {
  ...
  const committeeMembers = [
    {
      name: "Gyan Chand Bhudhiraja Ji",
      role: "Chairman",
      subtitle: "Chairman",
      image: "/assets/Gyanchandbhundhiraja.jpg"
    },
    {
      name: "Naresh Gulati Ji",
      role: "General Secretary",
      subtitle: "General Secretary",
      image: "/assets/nareshgulati.png"
    },
    {
      name: "Harvansh Gulati Ji",
      role: "Convenor",
      subtitle: "Convenor",
      image: "/assets/convenor1.jpeg"
    },
  ];
  ...
  return (
    <div className="min-h-screen pt-20" style={{ backgroundColor: '#F5E6D3' }}>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          <h2
            className="text-3xl md:text-4xl font-bold text-center mb-8 md:mb-12 px-4"
            style={{ color: '#8B2635' }}
          >
          ...
          <div className="relative max-w-4xl mx-auto px-2 sm:px-4">
            <div className="flex items-center justify-center gap-2 md:gap-8">
              ...
              <div className="flex-1 bg-white rounded-lg shadow-lg p-2 sm:p-4 md:p-8 min-w-[220px]">
                <div className="flex flex-col md:flex-row items-center gap-4 md:gap-12">
                  ...
                  {/* Name and Subtitle */}
                  <div className="w-full md:w-3/5 text-center md:text-left flex flex-col items-center md:items-start justify-center">
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-0.5 text-gray-800">
                      {committeeMembers[currentMember].name}
                    </h3>
                    <p className="text-sm sm:text-base md:text-lg text-red-800">
                      {committeeMembers[currentMember].subtitle}
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Member indicators (only first 3 members) */}
            <div className="flex justify-center mt-2 sm:mt-4 md:mt-6 space-x-2">
              {committeeMembers.slice(0, 3).map((_, index) => (
                <button
                  key={index}

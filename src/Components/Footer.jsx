          ...
          <div>
            ...
            <nav className="space-y-4">
              <div>
                <a
                  href="/"
                  className="text-gray-300 hover:text-white transition-colors duration-200 text-base flex items-center gap-2 justify-center md:justify-start w-full"
                >
              ...
              <div>
                <a
                  ...
                  className="text-gray-300 hover:text-white transition-colors duration-200 text-base flex items-center gap-2 justify-center md:justify-start w-full"
                >
                  <span role="img" aria-label="gallery">🖼️</span> Gallery and Participation
                </a>
              </div>
              <div>
                <a
                  ...
                  className="text-gray-300 hover:text-white transition-colors duration-200 text-base flex items-center gap-2 justify-center md:justify-start w-full"
                >
                  <span role="img" aria-label="donate">💸</span> Donations and Contact
                </a>
              </div>
            </nav>
          </div>
          ...
          <div className="text-center space-y-3">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-xs text-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-500">
                  Managed by <span className="text-blue-400 font-medium">AUM CONSULTANT</span>
                </span>
              </div>
            </div>
